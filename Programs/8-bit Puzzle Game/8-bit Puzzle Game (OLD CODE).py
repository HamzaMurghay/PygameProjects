...
name_font = pg.font.Font("../../assets/fonts/garet/Garet-Heavy.ttf", 18)
...
cave_backg = pg.image.load(
    '../../assets/graphics/8-Bit Pixel Game/main_code/cave background.png').convert_alpha()
cave_backg_faded = pg.image.load(
    '../../assets/graphics/8-Bit Pixel Game/main_code/cave background_faded.png').convert_alpha()
textbox = pg.image.load(
    '../../assets/graphics/8-Bit Pixel Game/main_code/textbox_trimmed.png').convert_alpha()
...
level_description = pg.image.load(
    '../../assets/graphics/8-Bit Pixel Game/main_code/level_description.png')

level_lock_chains = pg.image.load(
    '../../assets/graphics/8-Bit Pixel Game/main_code/chains_trimmed.png').convert_alpha()
...
def chose_ee_sprite():
    ...
    if dialouge_index == 1:
        namebar_font = pg.font.Font('../../assets/fonts/garet/Garet-Heavy.ttf', 12)
...
level_statuses = [True, "This level is locked, complete the previous 8-bit Puzzle Game to unlock it."]
